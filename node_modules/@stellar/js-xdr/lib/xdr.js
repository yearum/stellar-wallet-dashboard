...
class Array extends _xdr_type__WEBPACK_IMPORTED_MODULE_0__.NestedXdrType {
  constructor(childType, length, maxDepth = _xdr_type__WEBPACK_IMPORTED_MODULE_0__.NestedXdrType.DEFAULT_MAX_DEPTH) {
    super(maxDepth);
  ...
  read(reader, remainingDepth = this._maxDepth) {
    ...
    if (this._length > reader.remainingBytes()) {
      throw new _errors__WEBPACK_IMPORTED_MODULE_1__.XdrReaderError(`Array length ${this._length} exceeds remaining ${reader.remainingBytes()} bytes`);
    }
    _xdr_type__WEBPACK_IMPORTED_MODULE_0__.NestedXdrType.checkDepth(remainingDepth);
    const result = [];
    // read values
...
class Option extends _xdr_type__WEBPACK_IMPORTED_MODULE_1__.NestedXdrType {
  constructor(childType, maxDepth = _xdr_type__WEBPACK_IMPORTED_MODULE_1__.NestedXdrType.DEFAULT_MAX_DEPTH) {
    super(maxDepth);
    this._childType = childType;
  }
   ...
   */
  read(reader, remainingDepth = this._maxDepth) {
    _xdr_type__WEBPACK_IMPORTED_MODULE_1__.NestedXdrType.checkDepth(remainingDepth);
...
class Struct extends _xdr_type__WEBPACK_IMPORTED_MODULE_1__.NestedXdrType {
  ...
  static create(context, name, fields, maxDepth = _xdr_type__WEBPACK_IMPORTED_MODULE_1__.NestedXdrType.DEFAULT_MAX_DEPTH) {
...
class Union extends _xdr_type__WEBPACK_IMPORTED_MODULE_2__.NestedXdrType {
   ...
   */
  static read(reader, remainingDepth = this._maxDepth) {
    _xdr_type__WEBPACK_IMPORTED_MODULE_2__.NestedXdrType.checkDepth(remainingDepth);
  ...
  static create(context, name, config, maxDepth = _xdr_type__WEBPACK_IMPORTED_MODULE_2__.NestedXdrType.DEFAULT_MAX_DEPTH) {
...
class VarArray extends _xdr_type__WEBPACK_IMPORTED_MODULE_1__.NestedXdrType {
  constructor(childType, maxLength = _unsigned_int__WEBPACK_IMPORTED_MODULE_0__.UnsignedInt.MAX_VALUE, maxDepth = _xdr_type__WEBPACK_IMPORTED_MODULE_1__.NestedXdrType.DEFAULT_MAX_DEPTH) {
    super(maxDepth);
    this._childType = childType;
    this._maxLength = maxLength;
  }
  ...
  read(reader, remainingDepth = this._maxDepth) {
    ...
    if (length > reader.remainingBytes()) {
      throw new _errors__WEBPACK_IMPORTED_MODULE_2__.XdrReaderError(`VarArray length ${length} exceeds remaining ${reader.remainingBytes()} bytes`);
    }
    const result = [];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   NestedXdrType: () => (/* binding */ NestedXdrType),
...
class NestedXdrType extends XdrCompositeType {
  ...
  static checkDepth(remainingDepth) {
    ...
    if (remainingDepth < 0) {
      throw new _errors__WEBPACK_IMPORTED_MODULE_2__.XdrReaderError('exceeded max decoding depth');
    }
  }
}
